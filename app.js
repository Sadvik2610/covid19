  ...
  if (jwt === undefined) {
    ...
    jwttoken.verify(jwt, 'secretkey', async (err, payload) => {
      if (err) {
        ...
        console.log(
          'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImNocmlzdG9waGVyX3BoaWxsaXBzIiwiaWF0IjoxNzIxMjEwMDk5fQ.HyN5CL3On74KVZpmcPskPV_tv_XRuCaEkiCMh6Xptoc',
        )
        next()
      }
    })
